...
<?php $this->beginPage() ?>
    ...
    <div class="wrapper">
        <!-- Wrapper Start -->
        <nav class="navbar navbar-inverse <?php if(Url::to()!=='/'){?>navbar-inside<?php }?> navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/hotels');}else{ echo Url::to('hotels');}?>">Гостиницы</a></li>
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/tours');}else{ echo Url::to('tours');}?>">Туры</a></li>
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/interesting');}else{ echo Url::to('interesting');}?>">Интересное</a></li>
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/about');}else{ echo Url::to('about');} ?>">О нас</a></li>
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/news');}else{ echo Url::to('news');}?>">Новости</a></li>
                        <li><a href="<?php if(Url::to()=='/'){ echo Url::to('site/contact');}else{ echo Url::to('contact');}?>">Контакты</a></li>
                        <li>
                            <a class="nav-link" href="http://instagram.com/">
